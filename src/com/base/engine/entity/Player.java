...
import com.base.engine.graphics.Camera;
...
public class Player {
	...
	private static final float GUN_FIRE_SIZE = 0.23f;
	private static final float GUN_FIRE_OFFSET_X = 0.0043f;
	private static final float GUN_FIRE_OFFSET = 0.084f;
